...
describe('FooterComponent in host context', () => {
  ...
  it('should display subFooter based on input', () => {
    const subFooterLink = fixture.nativeElement.querySelector('.rhc-page-footer__subfooter-layout');
    expect(subFooterLink).toBeTruthy();

    component.subFooter = false;
    fixture.detectChanges();
    const subFooterLinkAfterChange = fixture.nativeElement.querySelector('.rhc-page-footer__subfooter-layout');
